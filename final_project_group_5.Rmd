...
if (runSample) {
  x <- coda.samples(m, c("delta", "eta", "rho", "beta.defense", "beta.home", "beta.away", "sigmasq"), n.iter=NSim)  
  save(file="fdp.jags.samples.Rdata", list="x")
} else {
